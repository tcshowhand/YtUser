...
echo <<<eof
    ...
    $(document).ready(function(){
      $("#cmbCateID").change(function(){
        objectid = document.getElementById('cmbCateID').value;
        object = document.getElementById('editCustomMeta');
        $.post(bloghost+'zb_users/plugin/CustomMeta/field.php',
		{
		"objectid":objectid,
		},
		function(data){
