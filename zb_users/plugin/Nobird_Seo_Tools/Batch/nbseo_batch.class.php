<?php
/**
 * Z-BlogPHP nbseo_batch
 * @package nbseo_batch.class
 * @subpackage nbseo_batch.class.php
 */

/**
 * nbseo_batch main class
 */
class nbseo_batch {
	...
	public function __construct()
	{
		...
		$this->categories = array_merge(
			...
			$GLOBALS['nbseo_batch_register_cate']
		);
		$this->scan_dir();
	}
	...
	public function scan_dir() {
		...
		$this->modules = $GLOBALS['nbseo_batch_register_array']; 
