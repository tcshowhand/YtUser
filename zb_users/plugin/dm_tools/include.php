...
function ActivePlugin_dm_tools() {
	global $zbp,$dm_tools;
	Add_Filter_Plugin('Filter_Plugin_Edit_Response2','dm_tools_Edit_Response2');
	
if ($zbp->CheckPlugin('UEditor')&&$zbp->Config($dm_tools['name'])->dm_tools_ueditorplugs_ueditor) {
	Add_Filter_Plugin('Filter_Plugin_Edit_Response', 'dm_tools_Edit_Response');
}
...
//Uditor按钮
function dm_tools_Edit_Response2(){
	global $zbp,$dm_tools;
...
function dm_tools_Edit_Response(){
	global $zbp,$dm_tools;
