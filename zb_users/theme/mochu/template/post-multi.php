...
<header>
<h2><a target="_blank" href="{$article.Url}" title="{$article.Title}" rel="bookmark">{$article.Title}</a></h2> 
<span class="archive-list-header"> 
<span class="archive-list-lei"><i class="fa fa-user"></i>{$article.Author.StaticName}</span> 
