<li class="cate<?php  echo $article->Category->ID;  ?> auth<?php  echo $article->Author->ID;  ?>">
	<div class="timg">
		<?php 
		 ...
		 ?>
		<a href="<?php  echo $article->Url;  ?>" title="<?php  echo $article->Title;  ?>"><img src="<?php  echo $temp;  ?>" alt="<?php  echo $article->Title;  ?>" /></a>
		<div class="tinfo"><a href="<?php  echo $article->Url;  ?>" title="<?php  echo $article->Title;  ?>"><?php  echo $article->Title;  ?></a></div>
	</div>
	<div class="tsale">
