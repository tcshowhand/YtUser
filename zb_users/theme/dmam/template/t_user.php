...
<div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
		...
		<small class="am-fr"><a href="{$host}zb_system/admin/?act=admin">后台切换</a> / <a href="{$host}?Resetpassword">重置密码</a></small>
      </div>
      <hr/>
    ...
    <input id="edtGuid" name="Guid" type="hidden" value="{$user.Guid}" />
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" placeholder="姓名 / Name" id="edtAlias" name="Alias" value="{$user.StaticName}">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="email" id="edtEmail" name="Email" value="{$user.Email}" placeholder="输入你的电子邮件 / Email">
                <small>邮箱你懂得...</small>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="tel" id="meta_Tel" name="meta_Tel" value="{$user.Metas.Tel}" placeholder="输入你的电话号码 / Telephone">
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="number" pattern="[0-9]*" id="meta_qq" name="meta_qq" value="{$user.Metas.qq}" placeholder="输入你的QQ号码">
              </div>
            </div>
            <div class="am-form-group">
              <label for="meta_txwb" class="am-u-sm-3 am-form-label">腾讯微博</label>
              <div class="am-u-sm-9">
                <input type="text" id="meta_txwb" name="meta_txwb" value="{$user.Metas.txwb}" placeholder="输入你的腾讯微博网址">
              </div>
            </div>
            <div class="am-form-group">
              <label for="meta_xlwb" class="am-u-sm-3 am-form-label">新浪微博 / Weibo</label>
              <div class="am-u-sm-9">
                <input type="text" id="meta_xlwb" name="meta_xlwb" value="{$user.Metas.xlwb}" placeholder="输入你的微博网址 / Weibo">
              </div>
            </div>
            <div class="am-form-group">
              <label for="meta_renren" class="am-u-sm-3 am-form-label">人人网</label>
              <div class="am-u-sm-9">
                <input type="text" id="meta_renren" name="meta_renren" value="{$user.Metas.renren}" placeholder="输入你的人人网网址">
              </div>
            </div>
            <div class="am-form-group">
              <label for="edtIntro" class="am-u-sm-3 am-form-label">简介 / Intro</label>
              <div class="am-u-sm-9">
                <textarea class="" rows="5" id="edtIntro" name="Intro" placeholder="输入个人简介">{$user.Intro}</textarea>
...
function checkInfo(){
    $.post(bloghost+'zb_users/plugin/YtUser/cmd.php?act=MemberPst&token={$zbp->GetToken()}',{
        ...
        "meta_qq":$("input[name='meta_qq']").val(),
		"meta_txwb":$("input[name='meta_txwb']").val(),
		"meta_xlwb":$("input[name='meta_xlwb']").val(),
		"meta_renren":$("input[name='meta_renren']").val(),
