...
body{background: #dfdfdf url(<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/style/images/404_bg.jpg) repeat; font-family: Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased; overflow: hidden;}
...
#main #content h2{background: url(<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/style/images/404_s-divider.jpg) no-repeat; background-position: bottom; padding: 12px 0 22px 0; font: 20px 'TeXGyreScholaRegular', Arial, sans-serif; color: #8e8e8e; text-align: center;}
