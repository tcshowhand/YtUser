...
<header>
<h2><span class="zhiding">【推荐】</span><a target="_blank" href="<?php  echo $article->Url;  ?>" title="<?php  echo $article->Title;  ?>" rel="bookmark"><?php  echo $article->Title;  ?></a></h2> 
<span class="archive-list-header"> 
<span class="archive-list-lei"><i class="fa fa-folder-open-o"></i><a href="<?php  echo $article->Category->Url;  ?>" title="查看<?php  echo $article->Category->Name;  ?>的全部文章"><?php  echo $article->Category->Name;  ?></a> </span> 
