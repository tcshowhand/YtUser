...
<div class="container main">
		...
		<div class="shop">
			...
			<div class="shopimg lf">
				<img src="<?php  echo $article->Metas->mochu_tupian;  ?>" alt="<?php  echo $article->Title;  ?>" title="<?php  echo $article->Title;  ?>" />
			</div>
			<div class="shopul lf">
				<ul>
					<li><strong>商品活动：</strong><?php  echo $article->Metas->mochu_shiyong;  ?></li>
					<li><strong>商品价格：</strong><span><?php  echo $article->Metas->mochu_jiage;  ?></span>&nbsp;元</li>
					<li><strong>已售数量：</strong><span><?php  echo $article->Metas->mochu_yishou;  ?></span>&nbsp;套</li>
					<li><strong>发布日期：</strong><?php  echo $article->Time('Y-m-d');  ?>&nbsp;&nbsp;(此日期为商品在本站发布的时间)</li>
					<li><strong>商品特点：</strong><?php  echo $article->Metas->mochu_tedian;  ?></li>
				</ul>
				<div class="buy">
...
<i class="fa fa-thumbs-o-down"></i><i class="sf-praise-sdk" sfa='num' data-value='2' data-postid='<?php  echo $article->ID;  ?>'><?php  echo $sf_praise_sdk->value2;  ?></i>人鄙视
			...
			<div class="nextnav">
			  	<div class="nextnav-lf lf"><span><i class="fa fa-angle-left"></i> 上一篇</span>
				<?php if ($article->Prev) { ?><a href="<?php  echo $article->Prev->Url;  ?>" title="<?php  echo $article->Prev->Title;  ?>"><?php  echo $article->Prev->Title;  ?></a><?php }else{  ?>博主有点懒,啥也没写!<?php } ?>
				</div>
