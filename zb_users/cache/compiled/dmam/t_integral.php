...
<div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">积分充值</strong> / <small>Intergral</small></div>
      </div>
      <hr/>
 ...
 <form cid="edit" name="edit" method="post" class="dm-admin-info am-form am-padding am-form-horizontal" action="#">
	...
	<label for="invitecode" class="am-u-sm-3 am-form-label">充值卡</label>
	<div class="am-u-sm-9">
	<input required="required" type="text" type="text" name="invitecode" id="invitecode" placeholder="卡密">
		<small><?php  echo $zbp->Config('YtUser')->integral_text;  ?></small>
	</div>
	</div>
	<div class="am-form-group">
	...
	<div class="am-form-group">
	  <div class="am-u-sm-9 am-u-sm-push-3">
		<button type="button" onclick="return Integral();" class="am-btn am-btn-primary">充值</button>
	  </div>
	</div>
</form>
    </div>
