...
<head>
	...
	<link href="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/style/base.css" rel="stylesheet" type="text/css"/>
	<link href="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/style/home.css" rel="stylesheet" type="text/css"/>
	...
	<script type="text/javascript" src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/script/jquery.cookie.js"></script>
...
<script src="<?php  echo $host;  ?>zb_system/script/c_admin_js_add.php" type="text/javascript"></script>
</head>
	<style type="text/css">
	    	...
	    	<div class="home-wrap">
	    		<div class="home-content">
	    			<div class="home-albumPage feedList">
						<h1 class="lh30 fix yh f24 fb mb10" nodetype="projectTitle"><?php  echo $article->Title;  ?></h1>
...
<div class="index-logina opacity70W grey lh30">
    ...
    <form method="post" action="#">
		...
		<div class="mt20 pl10" id="inputbox">
			<p>
				<input type="text" class="inputTxt inputTxtH30" id="edtUserName" name="edtUserName" size="20" value="<?php  echo GetVars('username', 'COOKIE')  ?>" tabindex="1" />
			</p>
			<p class="pt10">
		...
		<div class="fix pt10 pl10">
            ...
            <div class="fr"> <a href="<?php  echo $host;  ?>zb_users/plugin/DF_findpassword" class="blue">忘记密码？</a></div>
		</div>
		<div class="pt10 pl10"><input id="btnPost" name="btnPost" type="submit" value="登录" class="button" tabindex="4"/> 还没有帐号？<a href="<?php  echo $host;  ?>?reg" class="red">立即注册！</a></div>
...
$("#btnPost").click(function(){
	...
	$("#edtUserName").remove();
	$("#edtPassWord").remove();
	$("form").attr("action","<?php  echo $host;  ?>zb_users/plugin/YtUser/cmd.php?act=verify");
